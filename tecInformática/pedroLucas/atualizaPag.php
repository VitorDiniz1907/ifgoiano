                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col s8 input-field offset-s2">
                                    <input type="text" name="nome" value="<?php echo $pag->getNome();?>">
                            ...
                            <?php
                                if(isset($_POST['submit'])){
                                    ...
                                    $pag->setNome($_POST['nome']);
                                    
                                    $result = $dao->update($pag);
                                    ...
                                    if((unserialize ($_SESSION['usuario'])->getStatus()) == 1){
                                        if($result){
                                            ...
                                            echo "<script>alert('Erro ao Alterar Forma de Pagamento')</script>";
                                        }
                                    }
