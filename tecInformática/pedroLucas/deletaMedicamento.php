                        ...
                        <form method="POST">
                            <div class="row">
                                <div class="col s8 offset-s3">
                                    <h3>Atualize um produto</h3>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col s4 input-field offset-s2">
                                    <input readonly disabled type="text" name="nome" value="<?php echo $medicamento->getNome();?>">
                                    <label for="nome">Nome</label>
                                </div>

                                <div class="col s2 input-field">
                                    <input readonly disabled type="number" name="qnt" min="0" value="<?php echo $medicamento->getQuantidade();?>">
                                    <label for="qnt">Quantidade</label>
                                </div>
                                <div class="col s2 input-field">
                                    <input readonly disabled type="number" name="valor" step="0.01" min="0" value="<?php echo $valor;?>">
                                    <label readonly disabled for="valor">Valor</label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col s8 input-field offset-s2">
                                    <textarea readonly disabled id="textarea1" class="materialize-textarea" name="bula"><?php echo $medicamento->getBula();?></textarea>
                            ...
                            <?php
                                if(isset($_POST['submit'])){
                                    ...
                                    $result = $dao->delete($medicamento);
                                    

                                    if($result){
                                        echo "<script>alert('Deletar com Sucesso')</script>";
                                        echo "<script>window.location.href='consultaMedicamento.php'</script>";
                                    }else{
                                        echo "<script>alert('Erro ao Deletar Medicamento')</script>";
                                    }
