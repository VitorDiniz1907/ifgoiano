                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col s8 input-field offset-s2">
                                    <input readonly disabled  type="text" name="nome" value="<?php echo $pag->getNome();?>">
                            ...
                            <div class="row">
                                <div class="col s4 offset-s5">
                                    <button class="btn waves-effect waves-light r red accent-4" type="submit" name="submit" id="submit">Deletar
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    if((unserialize ($_SESSION['usuario'])->getStatus()) == 1){
                                        if($result){
                                            ...
                                            echo "<script>alert('Erro ao Deletar Forma de Pagamento')</script>";
                                        }
                                    }
