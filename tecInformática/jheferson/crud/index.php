...
if(unserialize($_SESSION['logado'])->getStatus() == 0){
  echo "<script>alert('Você não tem permissão de acesso à essa Página')
...
<html lang="en">
  ...
  <a class="btn btn-danger" href="../page/sair.php" role="button">Sair</a>
