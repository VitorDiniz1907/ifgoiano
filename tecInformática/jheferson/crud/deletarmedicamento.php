...
<html lang="en">
  ...
  <button type="submit" name="enviar" class="btn btn-primary btn-lg">Deletar Medicamentos</button>
...
<?php 
                if(isset($_POST['enviar'])){
                   ...
                   $dao = new DaoMedicamento();
                   if($dao->delete($idmedicamento)==TRUE){
                       echo "<script> alert('medicamento deletado com sucesso ') </script>";
                       echo "<script> window.location.href='consultamedicamento.php'</script> ";
                   }else{echo" nada deletado";}
