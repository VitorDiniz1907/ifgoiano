...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="hero is-dark">
            <h1 class="title has-text-ligth has-text-centered">Deletar Medicamento</h1>
        </section>
                    ...
                    <div class="box">
                        <form method="POST">
                            <div class="field">
                                ...
                                <div class="control"><input type="text" readonly disabled name="nome" class="input" required value="<?php echo $m->getNome();?>"></div>
                            </div>
                            <div class="field">
                                <label class="label">Quantidade</label>
                                <div class="control"><input type="number" readonly disabled min="0" name="quantidade" class="input" required value="<?php echo $m->getQuantidade();?>"></div>
                            </div>
                            <div class="field">
                                <label  class="label">Valor</label>
                                <div class="control"><input type="number" readonly disabled step="0.01" min="0.00" name="valor" class="input" required value="<?php echo $valor;?>"></div>
                            </div>
                            <div class="field">
                                <label class="label">Bula</label>
                                <div class="control"><textarea class="textarea" readonly disabled name="bula" required><?php echo $m->getBula();?></textarea></div>
                            </div>
