...
<html>
    ...
    <body>
                        ...
                        foreach($farmacia as $key => $f){
                            ...
                            echo"<form method='POST'>
                                <tr>
                                    ...
                                    <td>{$f->getRazao()}</td>
                                    <td>
                                        <button class='button'><a href='atualizaFarma.php?id=".$f->getId()."'>Atualizar</a></button>
                                        <button class='button'><a href='deletaFarma.php?id=".$f->getId()."'>Deletar</a></button>
                                    </td>
                                </tr>
                            </form>";
        ...
        <a class="button is-success is-rounded" href="cadastrarFarmacia.php">Adicionar Farmácia</a>
    </body>
</html>