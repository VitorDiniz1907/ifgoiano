...
include_once("../dao/daopagamento.class.php");
include_once("../models/pagamento.class.php");
...
<html lang="en">
  ...
  <button type="submit" name="enviar" class="btn btn-primary btn-lg">Cadastrar Pagamento</button>
  <button> <a class=" text-light nav-item nav-link bg-primary " href="consultapagamento.php">VIZUALIZAR PAGAMENTOS</a></button>
...
<?php 
                if(isset($_POST['enviar'])){
                   ...
                   if($dao->salvar($pagamento)>0){
                       echo "<script> alert('Forma de Pagamento cadastrado com sucesso ') </script>";
