                                ...
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col s4 offset-s5">
                                            <button class="btn waves-effect blue accent-4" type="submit" name="finaliza">Finalizar Compra<i class="material-icons">shopping_cart</i></button>
                                        </div>
                                    </div>
                                    <?php
