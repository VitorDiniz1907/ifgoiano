...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="hero is-dark">
            <h1 class="title has-text-ligth has-text-centered">Atualizar Pagamento</h1>
        </section>
                    ...
                    <div class="box">
                        <form method="POST">
                            <div class="field">
                                ...
                                <div class="control"><input type="text"  name="nome" class="input" required value="<?php echo $p->getNome();?>"></div>
                            </div>
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                $pag = $daoPag->atualiza($p);
                                

                                if($pag){
                                    echo "<script>alert('Atualizado com Sucesso')
                                    window.location.href='pagamento.php'</script>";
                                }else{
