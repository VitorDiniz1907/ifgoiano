...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="hero is-dark">
            <h1 class="title has-text-ligth has-text-centered">Deletar Pagamento</h1>
        </section>
                    ...
                    <div class="box">
                        <form method="POST">
                            <div class="field">
                                ...
                                <div class="control"><input type="text" readonly disabled name="nome" class="input" required value="<?php echo $p->getNome();?>"></div>
                            </div>
