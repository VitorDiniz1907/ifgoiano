...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="hero is-dark">
            <h1 class="title has-text-ligth has-text-centered">Cadastrar Medicamento</h1>
        </section>
                    ...
                    <div class="box">
                        <form method="POST">
                            ...
                            <div class="field">
                                ...
                                <div class="control"><input type="number" min="0" name="quantidade" class="input" required></div>
                            </div>
                            <div class="field">
                                <label  class="label">Valor</label>
                                <div class="control"><input type="number" step="0.01" min="0.00" name="valor" class="input" required></div>
                            </div>
                            <div class="field">
                                <label class="label">Bula</label>
                                <div class="control"><textarea class="textarea" name="bula" required></textarea></div>
                            </div>
