...
<html lang="pt-br">
    ...
    <body>
        ...
        <section class="hero is-dark">
            <h1 class="title has-text-ligth has-text-centered">Atualizar Farmácia</h1>
        </section>
                    ...
                    <div class="box">
                        <form method="POST">
                            <div class="field">
                                ...
                                <div class="control"><input type="text"  name="nome" class="input" required value="<?php echo $f->getNome();?>"></div>
                            </div>
                            <div class="field">
                                <label class="label">Telefone</label>
                                <div class="control"><input type="text" name="telefone" class="input" required value="<?php echo $f->getTelefone();?>"></div>
                            </div>
                            <div class="field">
                                <label  class="label">CNPJ</label>
                                <div class="control"><input type="text" name="cnpj" class="input" required value="<?php echo $f->getCnpj();?>"></div>
                            </div>
                            <div class="field">
                                <label class="label">Razao Social</label>
                                <div class="control"><input type="text" name="razao" class="input" required value="<?php echo $f->getRazao();?>"></div>
                            </div>
